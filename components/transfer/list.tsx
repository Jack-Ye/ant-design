...
export default class TransferList extends React.Component<TransferListProps, any> {
  ...
  render() {
    ...
    const availableDataSource = searchFilteredDataSource.filter(item => !item.disabled);
    const checkStatus = this.getCheckStatus(availableDataSource);
    ...
    const checkAllCheckbox = (
      <Checkbox
        ...
        onChange={() => this.props.handleSelectAll(availableDataSource, checkedAll)}
      />
    );
    return (
